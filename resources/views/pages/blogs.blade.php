            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="art-list">
                        ...
                        <div class="a-item">
                            <div class="thumbnail-image img-thumbnail"><a href="{{url('blog-detail/' . $blog->slug)}}}">
                                    <img src="{{asset('public/uploads/blog/'.$blog->image)}}" alt="png-image"></a></div>
                            <div class="info">
                                <div class="article_title ">
                                    <h2><a href="{{url('blog-detail/' . $blog->slug)}}" style="text-transform: initial;">{{$blog->title}}</a></h2>
                                </div>
