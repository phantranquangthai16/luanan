            ...
            <div class="container">
                <div class="row">
                    <div class="alert alert-info" role="alert">
                        ...
                        <p></p><p><span style="color:#e74c3c"><strong>Danh mục game liên quân . </strong></span><strong>Dịch vụ bán skin và tướng giá rẻ game LIÊN MINH TỐC CHIẾN&nbsp;</strong></p><p></p>
                    </div>
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    ...
                                    <a href="{{route('danhmuccon','nick-lien-quan')}}" title="Danh Mục Game Liên Quân" class="">
